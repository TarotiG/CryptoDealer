...
{
    private readonly IAccountDataProvider _accountService;
    private readonly IMarketDataProvider _marketDataService;
    private readonly ITradingDataProvider _tradingDataService;
    private readonly ITransferDataProvider _transferDataService;
    ...
    public DcaStrategy(IAccountDataProvider accountService, IMarketDataProvider marketDataService, ITradingDataProvider tradingDataService, ITransferDataProvider transferDataService)
    {
